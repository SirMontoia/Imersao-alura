...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        for (Map<String,String> filme: listaFilmes){      
            ...
            InputStream input = new URL (urlImagem).openStream(); // Aula 2: Adição de linhas que criam figurinhas personalizadas pegando como base as imagens dos posters do Objeto JSON da API

            var gerarFigurinha = new GeradorFigurinhas();
             
            gerarFigurinha.gerar(input, "saida/" + filme.get("title") + ".png");
